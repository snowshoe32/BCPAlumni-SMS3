...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['error'] == UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['photo']['tmp_name'], $target_file)) {
            ...
            $updateSql = "UPDATE `bcp-sms3_news` SET headline = '$headline', publisher = '$publisher', date = '$date', description = '$description', photo = '$photo_path' WHERE id = $id";
        } else {
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="publisher" name="publisher" value="<?php echo htmlspecialchars($news['publisher']); ?>" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="embed" name="embed" rows="3"><?php echo htmlspecialchars($news['embed'] ?? ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($news['photo'])): ?>
                                        <div style="position: relative; display: inline-block;">
                                            ...
                                            <a href="remove_photo.php?id=<?php echo $id; ?>" style="position: absolute; top: 0; right: 0; color: white; text-decoration: none; padding: 2px 5px; font-size: 12px; background: gray; border-radius: 50%;">X</a>
                                        </div>
                                    <?php endif; ?>
                                    <input type="file" class="form-control" id="photo" name="photo">
                                </div>
                                <button type="submit" class="btn btn-primary">Update News</button>
                                <a href="admin_managenews.php" class="btn btn-secondary">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
