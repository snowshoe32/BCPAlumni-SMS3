...
<input type="text" class="form-control" name="jobtitle" placeholder="" value="<?php echo htmlspecialchars($jobtitle); ?>" required disabled>
</div>
<div class="row g-3">
                  <label for="inputPassword" class=" col-form-label">Job Description</label>
                  <div class="col-md-10">
                    <textarea class="form-control" style="height: 150px" name="description" value="<?php echo htmlspecialchars($description); ?>" disabled></textarea>
                  </div>
                </div>
                <div class="row g-3">
                  <label for="inputPassword" class=" col-form-label">Job Qualifications</label>
                  <div class="col-md-10">
                    <textarea class="form-control" style="height: 150px" name="qualification" value="<?php echo htmlspecialchars($qualification); ?>" disabled></textarea>
                  </div>
                </div>

        <div class="col-md-10">
<label class="form-label">Location </label>
<input type="text" class="form-control" name="location" placeholder="" value="<?php echo htmlspecialchars($location); ?>" required disabled>
</div>

        <div class="col-md-10">
<label class="form-label">Send your resume to: </label>
<input type="email" class="form-control" name="email" placeholder="" value="<?php echo htmlspecialchars($email); ?>"required disabled>
</div>
              <div class="row g-3">
                  <label for="inputNumber" class="col-form-label">Job Image</label>
                  <div class="col-md-10">
                    <input class="form-control" type="file" id="formFile" name="image" value=" <?php echo htmlspecialchars($image); ?>"disabled>
                  </div>
                </div>
       ...
       <form action="upcoming_events.php" method="POST">
          ...
          <div class="text-center">
           <a href="job-post-manage.php" class="btn btn-primary">Back</a>
          </div>
