...
?>
    ...
    <div class="col-sm-10">
        <input type="time" class="form-control" name="start_time" value="<?php echo htmlspecialchars($input_start_time); ?>">
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <input type="time" class="form-control" name="end_time" value="<?php echo htmlspecialchars($input_end_time); ?>">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 150px" name="description" ><?php echo htmlspecialchars($full_description); ?></textarea>
                  </div>
                </div>
                <div class="row mb-3">
    ...
    <div class="col-sm-3">
        <select name="status" class="form-control" required> 
            ...
            <option value="Ended" <?php if ($row['status'] === 'Ended') echo 'selected'; ?>>Ended</option>
            ...
            <option value="Cancelled" <?php if ($row['status'] === 'Cancelled') echo 'selected'; ?>>Cancelled</option>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="organizer" value="<?php echo $row['organizer']?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Event Organizer Email</label>
                  <div class="col-sm-10">
                    <input type="email" class="form-control" name="organizer_email" value="<?php echo $row['organizer_email']?>">
                  </div>
                </div>
          ...
          <div class="col-sm-3">
           <input type="text" class="form-control" pattern="\d{11}" name="organizer_no" maxlength="11" 
